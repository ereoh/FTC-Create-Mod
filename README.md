...
3. Create a Minecraft installation to use this repo
   ...
   c. Name it something like "FTC Minecraft"
   d. Set version to release-neoforge-xxx, with version matching the Neoforge currently in the repo
   e. Set game directory to wherever you cloned this repo; like `C:\Games\Minecraft\FTC-Create-Mod`
4. Launch game!
